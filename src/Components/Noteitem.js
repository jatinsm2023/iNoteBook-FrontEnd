...
function Noteitem(props) {
  ...
  const [NOTE, setNote]=useState({title: note.title, description: note.description, tag: note.tag});
  const UPDATE = () =>{
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button
                  ...
                  data-modal-toggle="crud-modal" onClick={showModal}
                >
                  <svg
                    className="w-3 h-3"
                    aria-hidden="true"
              ...
              <div className="p-4 md:p-5">
                ...
                <button
                  ...
                  className="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={UPDATE}
                >
                 Update Note
                </button>
              </div>
